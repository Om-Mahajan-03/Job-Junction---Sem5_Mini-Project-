                ...
                <div class="owl-carousel-item position-relative">
                    ...
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">Find The Best Job That Fits You</h1>
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2"></p>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p class="mb-4">JobJunction connects job seekers with their dream careers.Our platform offers a vast selection of jobs across various industries, with a focus on remote opportunities. </p>
                        <p><i class="fa fa-check text-primary me-3"></i>Search and Filter Tools</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Extensive Job Listings</p>
